...
void freeClient(struct client *c) {
    ...
    if (Chat->maxclient == c->fd) {
        ...
        // it'll be less work in this scenario
...
int main(void) {
    ...
    while (1) {
        ...
        /* select() is a system call that monitors multiple file descriptors
         * to see if they're ready for some I/O operation. Here we use it
         * to monitor sockets to see if any are ready for read. */
